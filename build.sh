...
ARCHIVE_ARM="$BUILD_DIR/Shelf-arm64.xcarchive"
ARCHIVE_X86="$BUILD_DIR/Shelf-x86_64.xcarchive"
APP_NAME="Shelf.app"
...
xcodebuild archive \
  -project "$PROJECT_DIR/Shelf.xcodeproj" \
  -scheme "$SCHEME" \
...
echo "   DMG:  $DMG_PATH"
echo ""
lipo -info "$OUTPUT_APP/Contents/MacOS/Shelf"
